...
try:
    ...
    from star.model.ea_model import EaModel
import torch
...
parser.add_argument("--base-model-path", type=str, default="/basemodel",
...
with gr.Blocks(css=custom_css) as demo:
    ...
    with gr.Row():
        ...
        user_image = gr.Image(label="input figure", type="filepath")  
